...
public class LocationManagerDependencyFacotryTest {
  ...
  public void DefaultGetCurrentLocationManager() {
    ...
    assertNotSame(
        locationManagerMock, LocationManagerDependencyFactory.getCurrentLocationManager(context));
  }

  @Test
  public void onBindTest() {
    Intent intent = mock(Intent.class);
    LocationManagerDependencyFactory locationManagerDependencyFactory =
