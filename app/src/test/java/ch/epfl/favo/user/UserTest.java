...
public class UserTest {
  ...
  public void userCannotBeCreatedIfAlreadyExists() {
    assertThrows(
        NotImplementedException.class, () -> UserUtil.getSingleInstance().createAccount(user));
  }
  ...
  public void userCannotLoginIfAccountDoesNotExist() {
    ...
    assertThrows(
        NotImplementedException.class, () -> UserUtil.getSingleInstance().logInAccount(user));
  }

  @Test
  public void userCanLogOutOnlyIfLoggedIn() {

    assertThrows(NotImplementedException.class, () -> UserUtil.getSingleInstance().logOutAccount());
  }
  ...
  public void userGettersReturnCorrectValues() {
    ...
    String id = "cljTxHjLePBevqkjpGt1";
    ...
    User user = new User(id, name, email, deviceId, birthDate, acceptedFavors, requestedFavors);
