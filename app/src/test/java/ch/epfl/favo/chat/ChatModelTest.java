...
public class ChatModelTest {
  ...
  public void testToString() {
    ...
    assertEquals(
        String.format(
            "Chat{mId='%s', mName='testName', mMessage='testMessage', mMessageType=0', mUid='testUid', mFavorId='%s', mTimestamp=%s', mImagePath='testImagePath', mLatitude='1.23', mLongitude='1.25'}",
